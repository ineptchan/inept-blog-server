...
@Component
class ArticleFeaturedImageUploadCompletionHandler(
    ...
    override fun supports(purpose: Purpose): Boolean {
        return purpose == Purpose.ARTICLE_FEATURED_IMAGE
    }
    ...
    override fun handle(
        ...
        if (articleObjectStorage != null) {
            ...
            //更新文章封面
            articleRepository.updateFeaturedImageById(articleObjectStorage.article.id, url)
        } else {
